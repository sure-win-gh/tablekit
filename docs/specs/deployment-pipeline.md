...
- A job the bad release **added** keeps firing on schedule against code that may not have the route. Vercel executes a cron job even when its path 404s, so this shows up as recurring 404s in the logs rather than silence.
