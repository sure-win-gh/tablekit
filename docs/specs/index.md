...
| 4a| [`booking-page.md`](booking-page.md) | in progress | Rich TheFork-style hosted `/book` page for Core+: `settings.profile` (description/cuisine/price/address/geo) + aggregate rating from Google + internal reviews + gallery/calendar/map phases. Free keeps the simple page. Extends `widget.md`. |
