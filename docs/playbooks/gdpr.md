...
Most data we process is contact + booking metadata (Article 6 contract). Two paths may incidentally capture **special-category data** under Article 9 — dietary requirements (health), accessibility needs (disability), occasion notes that disclose health or family status:
