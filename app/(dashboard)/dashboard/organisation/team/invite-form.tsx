    ...
    <form action={formAction} className="space-y-3">
      <div className="grid gap-3 sm:grid-cols-[1fr_140px_auto]">
        ...
        <button
          type="submit"
          disabled={pending}
          className="bg-ink hover:bg-ink/90 disabled:opacity-60 inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium text-white transition"
        >
